...
<div class="container mt-4">
    <h4>Edit Toko</h4>
    <form action="<?= site_url('toko/update/'.$toko->id_toko) ?>" method="post" enctype="multipart/form-data" class="row g-3">
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            <label class="form-label">Logo Toko (Kosongkan jika tidak diubah)</label>
            <input type="file" name="logo_toko" class="form-control">
            <?php if ($toko->logo_toko): ?>
                <img src="<?= base_url('uploads/pembeli/toko/'.$toko->logo_toko) ?>" width="80" class="mt-2">
            <?php endif; ?>
        </div>
        <div class="col-12">
